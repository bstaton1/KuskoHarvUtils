...
get_var_name = function(var, escape = FALSE, is_title = TRUE, long_species_comp = FALSE) {
  ...
  var_name = switch(var,
                    ...
                    "total_sonar_count" = "Sonar Count",
                    "chinook_sonar_comp" = "Sonar % Chinook",
                    "I(chinook_sonar_comp^2)" = "Sonar % Chinook^2",
                    "chum_sonar_comp" = "Sonar % Chum",
                    "I(chum_sonar_comp^2)" = "Sonar % Chum^2",
                    "sockeye_sonar_comp" = "Sonar % Sockeye",
                    "I(sockeye_sonar_comp^2)" = "Sonar % Sockeye^2",
